...
public final class CatNetworking {

    private static final Identifier VARIANT_SYNC_ID = Identifier.of(SamuelRequiemMod.MOD_ID, "cat_variant_sync");

    private CatNetworking() {}
    ...
    public static void registerClient() {
        ClientPlayNetworking.registerGlobalReceiver(VariantSyncPayload.ID, (payload, context) ->
                context.client().execute(() ->
                        CatState.setClientVariant(payload.playerUuid(), payload.variantId())));
    }
