...
public final class BabyPiglinNetworking {

    public static final Identifier SYNC_ID =
            Identifier.of(SamuelRequiemMod.MOD_ID, "baby_piglin_sync");

    private BabyPiglinNetworking() {}
    ...
    public static void registerClient() {
        ClientPlayNetworking.registerGlobalReceiver(Payload.ID, (payload, context) ->
                context.client().execute(() -> {
                    BabyPiglinState.setClientBaby(payload.playerUuid(), payload.isBaby());
